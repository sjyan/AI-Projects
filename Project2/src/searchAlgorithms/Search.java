...
public abstract class Search {
	...
	protected int moveUtil(CandyLocation[][] board, int x, int y, Color color) {
		
		return checkUtil(board);
	}
	...
	protected int addAdjacent(CandyLocation[][] board, int x, int y, Color color) {
		int utility = 0;
	...
	protected void copyMove(CandyLocation[][] board, int x, int y, Color color) {
		board[x][y].setColor(color);
